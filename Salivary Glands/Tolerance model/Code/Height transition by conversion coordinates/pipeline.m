...
hTranWT={};
hTranEc={};
%[hTranWTsition,hTranWTsitionPredict]=recalculateCentroids(pathStructure, frame, cellsGroup, hTranWTsition, curvature, D , alpha,hCell,validCentroidCell)
...
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroids(WTpaths{2},1,[7,5,17,3],79.26*micronsToPixels,0.214,232.7*micronsToPixels,((21.1*pi)/180),107.23*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroids(WTpaths{2},'end',[50,53,38,43],73.9*micronsToPixels,0.240,216.66*micronsToPixels,((26*pi)/180),83.17*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroids(WTpaths{2},'end',[51,49,3,42],94.61*micronsToPixels,0.214,232.7*micronsToPixels,((4*pi)/180),107.23*micronsToPixels,3);
...
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroids(WTpaths{4},1,[21,29,18,37],37.97*micronsToPixels,0.261,191.41*micronsToPixels,((29.5*pi)/180),71.72*micronsToPixels,3);
...
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroids(WTpaths{5},1,[11,16,12,17],50.6*micronsToPixels,0.243,162.65*micronsToPixels,((1*pi)/180),65.06*micronsToPixels,3);
...
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroids(WTpaths{5},'end',[79,77,3,78],52.38*micronsToPixels,0.235,170.87*micronsToPixels,((16*pi)/180),65.47*micronsToPixels,3); %rareeee motif
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroids(WTpaths{5},'end',[84,87,83,64],45.41*micronsToPixels,0.254,165.63*micronsToPixels,((26.5*pi)/180),63.57*micronsToPixels,3);
...
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroids(Ecadhipaths{1},1,[24,27,25,29],25.44*micronsToPixels,0.19,81.13*micronsToPixels,((21*pi)/180),36.34*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroids(Ecadhipaths{1},'end',[85,75,83,43],30.3*micronsToPixels,0.236,79.9*micronsToPixels,((15*pi)/180),30.3*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroids(Ecadhipaths{1},'end',[89,88,47,45],72.9*micronsToPixels,0.246,90.21*micronsToPixels,((16.5*pi)/180),44.59*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroids(Ecadhipaths{2},1,[21,17,16,23],41.09*micronsToPixels,0.157,111.72*micronsToPixels,((6*pi)/180),46.23*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroids(Ecadhipaths{2},1,[25,20,22,24],5.14*micronsToPixels,0.092,99.59*micronsToPixels,((1*pi)/180),41.14*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroids(Ecadhipaths{4},'end',[97,86,71,78],33.7*micronsToPixels,0.156,80.1*micronsToPixels,((11*pi)/180),33.7*micronsToPixels,3);
% 
...
[hTranEc{end+1,1},~,hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroids(Ecadhipaths{4},1,[12,13,2,24],[],0.181, 75.43*micronsToPixels,((24.5*pi)/180),32.89*micronsToPixels,3);
