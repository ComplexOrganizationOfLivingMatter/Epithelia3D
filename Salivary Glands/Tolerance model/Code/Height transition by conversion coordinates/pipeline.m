...
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{1},'end',[68,67,22,58],57.2*micronsToPixels,0.192,237.09*micronsToPixels,((20*pi)/180),98.05*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{2},1,[7,5,17,3],79.26*micronsToPixels,0.214,232.7*micronsToPixels,((21.1*pi)/180),107.23*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{2},'end',[50,53,38,43],73.9*micronsToPixels,0.240,216.66*micronsToPixels,((26*pi)/180),83.17*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{2},'end',[51,49,3,42],94.61*micronsToPixels,0.214,232.7*micronsToPixels,((4*pi)/180),107.23*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{3},'end',[79,73,75,56],91.58*micronsToPixels,0.152,232.05*micronsToPixels,((12.2*pi)/180),98.62*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{3},'end',[64,69,68,42],93.86*micronsToPixels,0.151,269.09*micronsToPixels,((2.1*pi)/180),111.46*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{4},1,[21,29,18,37],37.97*micronsToPixels,0.261,191.41*micronsToPixels,((29.5*pi)/180),71.72*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{4},'end',[78,74,80,53],41.21*micronsToPixels,0.256,195.97*micronsToPixels,((21*pi)/180),73.68*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{4},'end',[71,69,70,56],34.9*micronsToPixels,0.213,183.45*micronsToPixels,((23*pi)/180),68.68*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{5},1,[11,16,12,17],50.6*micronsToPixels,0.243,162.65*micronsToPixels,((1*pi)/180),65.06*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{5},1,[16,20,15,24],40.85*micronsToPixels,0.197,162.48*micronsToPixels,((18*pi)/180),73.53*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{5},1,[25,31,28,29],52.93*micronsToPixels,0.373,178.76*micronsToPixels,((30*pi)/180),57*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{5},'end',[79,77,3,78],52.38*micronsToPixels,0.235,170.87*micronsToPixels,((16*pi)/180),65.47*micronsToPixels,3); %rareeee motif
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{5},'end',[84,87,83,64],45.41*micronsToPixels,0.254,165.63*micronsToPixels,((26.5*pi)/180),63.57*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{6},3,[23,16,17,21],38.14*micronsToPixels,0.180,167.85*micronsToPixels,((1*pi)/180),68.65*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{6},'end',[69,65,46,64],53.53*micronsToPixels,0.203,168.46*micronsToPixels,((8*pi)/180),66.91*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{6},'end',[65,83,66,56],39.23*micronsToPixels,0.180,167.85*micronsToPixels,((29*pi)/180),68.65*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{6},'end',[73,75,78,74],49.49*micronsToPixels,0.284,176.30*micronsToPixels,((49*pi)/180),65.98*micronsToPixels,3);
% [hTranWT{end+1,1},hTranWT{end+1,2},hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{7},1,[34,32,22,40],35.94*micronsToPixels,0.109,140.62*micronsToPixels,((3.5*pi)/180),62.9*micronsToPixels,3);
% 
% 
% % %Ecadhi
% 
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(Ecadhipaths{1},1,[11,7,9,10],12.05*micronsToPixels,0.218,68.53*micronsToPixels,((11.3*pi)/180),27.11*micronsToPixels,3); %rareeee motif
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(Ecadhipaths{1},1,[24,27,25,29],25.44*micronsToPixels,0.19,81.13*micronsToPixels,((21*pi)/180),36.34*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(Ecadhipaths{1},'end',[85,75,83,43],30.3*micronsToPixels,0.236,79.9*micronsToPixels,((15*pi)/180),30.3*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(Ecadhipaths{1},'end',[89,88,47,45],72.9*micronsToPixels,0.246,90.21*micronsToPixels,((16.5*pi)/180),44.59*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(Ecadhipaths{2},1,[21,17,16,23],41.09*micronsToPixels,0.157,111.72*micronsToPixels,((6*pi)/180),46.23*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(Ecadhipaths{2},1,[25,20,22,24],5.14*micronsToPixels,0.092,99.59*micronsToPixels,((1*pi)/180),41.14*micronsToPixels,3);
% [hTranEc{end+1,1},hTranEc{end+1,2},hTranEc{end+1,3},hTranEc{end+1,4},hTranEc{end+1,5},hTranEc{end+1,6},hTranEc{end+1,7},hTranEc{end+1,8},hTranEc{end+1,9},hTranEc{end+1,10},hTranEc{end+1,11},hTranEc{end+1,12},hTranEc{end+1,13},hTranEc{end+1,14},hTranEc{end+1,15},hTranEc{end+1,16},hTranEc{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(Ecadhipaths{4},'end',[97,86,71,78],33.7*micronsToPixels,0.156,80.1*micronsToPixels,((11*pi)/180),33.7*micronsToPixels,3);
% 
...
%WT
[hTranWT{end+1,1},~,hTranWT{end+1,3},hTranWT{end+1,4},hTranWT{end+1,5},hTranWT{end+1,6},hTranWT{end+1,7},hTranWT{end+1,8},hTranWT{end+1,9},hTranWT{end+1,10},hTranWT{end+1,11},hTranWT{end+1,12},hTranWT{end+1,13},hTranWT{end+1,14},hTranWT{end+1,15},hTranWT{end+1,16},hTranWT{end+1,17}]=recalculateCentroidsGlandsHeightTranPrediction(WTpaths{5},'end',[82,81,74,84],[],0.373,178.76*micronsToPixels,((84.5*pi)/180),57*micronsToPixels,2);
...
%% Transition
% [hTranGast{end+1,1},hTranGast{end+1,2},hTranGast{end+1,3},hTranGast{end+1,4},hTranGast{end+1,5},hTranGast{end+1,6},hTranGast{end+1,7},hTranGast{end+1,8},hTranGast{end+1,9},hTranGast{end+1,10},hTranGast{end+1,11},hTranGast{end+1,12},hTranGast{end+1,13},hTranGast{end+1,14},hTranGast{end+1,15},hTranGast{end+1,16},hTranGast{end+1,17}]=recalculateCentroidsGastrulationHeightTranPrediction(GastPath,1,hTransition,curvature,alpha,hCell,validCentroidCell);
% [hTranGast{end+1,1},hTranGast{end+1,2},hTranGast{end+1,3},hTranGast{end+1,4},hTranGast{end+1,5},hTranGast{end+1,6},hTranGast{end+1,7},hTranGast{end+1,8},hTranGast{end+1,9},hTranGast{end+1,10},hTranGast{end+1,11},hTranGast{end+1,12},hTranGast{end+1,13},hTranGast{end+1,14},hTranGast{end+1,15},hTranGast{end+1,16},hTranGast{end+1,17}]=recalculateCentroidsGastrulationHeightTranPrediction(GastPath,1,hTransition,curvature,alpha,hCell,validCentroidCell);
% [hTranGast{end+1,1},hTranGast{end+1,2},hTranGast{end+1,3},hTranGast{end+1,4},hTranGast{end+1,5},hTranGast{end+1,6},hTranGast{end+1,7},hTranGast{end+1,8},hTranGast{end+1,9},hTranGast{end+1,10},hTranGast{end+1,11},hTranGast{end+1,12},hTranGast{end+1,13},hTranGast{end+1,14},hTranGast{end+1,15},hTranGast{end+1,16},hTranGast{end+1,17}]=recalculateCentroidsGastrulationHeightTranPrediction(GastPath,1,hTransition,curvature,alpha,hCell,validCentroidCell);
% [hTranGast{end+1,1},hTranGast{end+1,2},hTranGast{end+1,3},hTranGast{end+1,4},hTranGast{end+1,5},hTranGast{end+1,6},hTranGast{end+1,7},hTranGast{end+1,8},hTranGast{end+1,9},hTranGast{end+1,10},hTranGast{end+1,11},hTranGast{end+1,12},hTranGast{end+1,13},hTranGast{end+1,14},hTranGast{end+1,15},hTranGast{end+1,16},hTranGast{end+1,17}]=recalculateCentroidsGastrulationHeightTranPrediction(GastPath,1,hTransition,curvature,alpha,hCell,validCentroidCell);
% [hTranGast{end+1,1},hTranGast{end+1,2},hTranGast{end+1,3},hTranGast{end+1,4},hTranGast{end+1,5},hTranGast{end+1,6},hTranGast{end+1,7},hTranGast{end+1,8},hTranGast{end+1,9},hTranGast{end+1,10},hTranGast{end+1,11},hTranGast{end+1,12},hTranGast{end+1,13},hTranGast{end+1,14},hTranGast{end+1,15},hTranGast{end+1,16},hTranGast{end+1,17}]=recalculateCentroidsGastrulationHeightTranPrediction(GastPath,1,hTransition,curvature,alpha,hCell,validCentroidCell);
...
clearvars -except hTranWT hTranEc hTranGast
