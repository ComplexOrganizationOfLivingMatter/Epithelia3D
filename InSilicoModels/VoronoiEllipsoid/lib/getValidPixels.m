...
%   Detailed explanation goes here
    ...
    pxsInInnerLayer = ((((pxXs / ellipsoidInfo.resolutionFactor) - ellipsoidInfoxOffset).^2) / ellipsoidInfo.xRadius^2) + ((((pxYs / ellipsoidInfo.resolutionFactor) - ellipsoidInfo.yOffset).^2) / ellipsoidInfo.yRadius^2) + ((((pxZs / ellipsoidInfo.resolutionFactor) - ellipsoidInfo.zOffset).^2) / ellipsoidInfo.zRadius^2);

    validPxs = pxsInInnerLayer > 0.99 & pxsInOutterLayer < 1.01;
