%Voronoi Noise - Inner salivary gland model. INSIDE RATIO
...
function Voronoi_noise_inner_ratio_salivary_gland_generator(i,j)
    ...
    W=512; % Size X axis
            ...
            %% Chose ramdon seed point into noisy region
            seeds_noise=[];
            ...
            FOLDER_1='..\Images\Photos\Inner cylindrical voronoi noise\Inside ratio';
            FOLDER_2='..\Images\Data\Inner cylindrical voronoi noise\Inside ratio';
