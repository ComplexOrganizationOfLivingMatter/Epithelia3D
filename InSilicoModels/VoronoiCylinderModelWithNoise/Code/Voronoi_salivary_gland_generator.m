...
Iteration=20; % Number of Lloyds-Voronoi iterations
Images=5; % Number of different random images
H=512; % Size Y axis 
W=512; % Size X axis
 ...
 for i=1:Images
     ...
     % Load seeds
     load(['..\Seeds\Salivary_Gland_outside_512x512_100_seeds_',num2str(i),'.mat'],'seeds')
     ...
     for j=1:Iteration
        ...
        valid_cells=setxor(1:100,no_valid_cells);
        
        %% Saving
        
        FOLDER_1='..\Images\Photos\External cylindrical voronoi';
        FOLDER_2='..\Images\Data\External cylindrical voronoi';

        Name=['Image_',num2str(i),'_Diagram_',num2str(j),'_Vonoroi_out'];
        
        save([FOLDER_2 '\' Name '.mat'],'L_original','seeds','new_seeds','seeds_values_before','new_seeds_values','border_cells','valid_cells','no_valid_cells')
