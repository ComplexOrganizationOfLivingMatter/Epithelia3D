function [] = mainCurvatureInEllipsoidSurface()
%MAINCURVATUREIINELLIPSOIDSURFACE Calculating curvature of ellipsoids
%   Main curvature analysis for regions studied in energy analysis.
    ...
    for i = 1 : length(filePaths)
        ...
        nameFile=dir([filePath '\randomizations\random_1\ellipsoid*']);

        for nHeight = 1 : length(nameFile)

            load([filePath '\randomizations\random_1\' nameFile(nHeight).name],'ellipsoidInfo','initialEllipsoid')
