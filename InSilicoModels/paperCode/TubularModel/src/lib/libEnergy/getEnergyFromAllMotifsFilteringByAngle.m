function [ dataEnergy ] = getEnergyFromAllMotifsFilteringByAngle(L_basal,noValidCells,totalPairs,vertices,borderCellsBasal,arrayValidVerticesBorderLeftBasal,arrayValidVerticesBorderRightBasal)
