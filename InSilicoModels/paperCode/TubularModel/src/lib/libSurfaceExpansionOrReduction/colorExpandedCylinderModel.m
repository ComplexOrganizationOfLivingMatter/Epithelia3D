...
load(['data\tubularModelSurfaceProjection\expansion\512x1024_' num2str(numSeeds) 'seeds\Image_10_Diagram_5\Image_10_Diagram_5.mat'],'listLOriginalProjection')
...
%     hold on
    path2save=(['data\tubularModelSurfaceProjection\expansion\' num2str(numSeeds) ' seeds\' num2str(numSeeds) 'cellsExpanded\']);
