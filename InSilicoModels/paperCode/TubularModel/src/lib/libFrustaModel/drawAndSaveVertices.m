...
%   Detailed explanation goes here
     ...
     for nSurf=1:numSurfaces
        ...
        if ~isempty(strfind(typeProjection,'expansion'))
            ...
            W_projection=round(size(L_img,2)*(1-apicalReductions(nSurf)));
        end    
            ...
            if ~isempty(strfind(typeProjection,'expansion'))
                ...
                verticesProjection.verticesPerCell=cellfun(@(x) [x(1,1),round(x(1,2)*(1-apicalReductions(nSurf)))],vertices.verticesPerCell,'UniformOutput',false);
                verticesProjection.verticesConnectCells=vertices.verticesConnectCells;
                verticesProjectionNoValidCells.verticesPerCell=cellfun(@(x) [x(1,1),round(x(1,2)*(1-apicalReductions(nSurf)))],verticesNoValidCells.verticesPerCell,'UniformOutput',false);
                verticesProjectionNoValidCells.verticesConnectCells=verticesNoValidCells.verticesConnectCells;
