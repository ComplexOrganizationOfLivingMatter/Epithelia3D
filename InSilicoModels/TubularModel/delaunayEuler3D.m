...
surfaceRatios = unique([1:0.25:10,1.8]);
...
fileName = ['delaunayCyl_Voronoi' num2str(nLloydIt+1) '_' num2str(numSeeds) 'seeds_sr' num2str(max(surfaceRatios)) '_15-May-2019.mat'];
