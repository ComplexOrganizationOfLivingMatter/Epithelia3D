...
surfaceRatios = unique([1:0.25:10]);
...
for nLloydIt = setNLloydIt
    ...
    fileName = ['delaunayCyl_Voronoi' num2str(nLloydIt+1) '_' num2str(numSeeds) 'seeds_sr' num2str(max(surfaceRatios)) '_23-May-2019.mat'];
