...
%         end
        ...
        if exist('dataVertices.mat','file')
            load('dataVertices.mat','dataVertID','cellWithVertices','pairOfVerticesTotal','clusterOfNeighs','clusterOfNeighsAux','verticesInfoExtreme','verticesInfoExtremeAux')
        else
            save('dataVertices.mat', 'dataVertID','cellWithVertices','pairOfVerticesTotal');
        end
...
%         save('dataVertices.mat','clusterOfNeighs','clusterOfNeighsAux','verticesInfoExtreme','verticesInfoExtremeAux','-append');
