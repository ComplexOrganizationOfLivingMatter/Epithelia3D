function mainTubularVoronoiModelProjectionSurface(numSeeds,basalExpansions,apicalReductions,numRandoms,Hinitial,Winitial,thresholdRes,diagramNumber)
...
%4 principal functions that are explained below.
    ...
    for typeP = 1 : length(kindProjection)
        ...
        if thresholdRes <= 1
            ...
            calculatePercentajeScutoidsByThreshold(directory2save,numSeeds,Hinitial,Winitial,numRandoms,kindProjection{typeP},thresholdRes,diagramNumber)
        end
...
%             energyCalculationVoronoiTubularModel(directory2save,nameOfFolder,length(listOfSurfaceRatios),numRandoms,kindProjection{typeP},numSeeds,basalExpansions,apicalReductions,diagramNumber)
%
