function [listSeedsProjected,listLOriginalProjection] = expansionOrReductionIterative(listOfSurfaceRatios,seedsOriginal,L_original,numCells,name2save,directory2save,kindProjection,nameOfFolder)
...
%    listDataAnglesNoTransitionMeasuredInBasal,listDataAnglesNoTransitionMeasuredInApical] = expansionOrReductionIterative(listOfSurfaceRatios,seedsOriginal,L_original,numCells,name2save,directory2save,kindProjection,nameOfFolder)
