function [totalMeansMean,totalStdsMean,totalMeansStd,totalStdsStd] = getMeans
    ...
    vor1 = table2array(readtable('MeanPerim^2_Voronoi_1.xls'));
    vor2 = table2array(readtable('MeanPerim^2_Voronoi_2.xls'));
    vor3 = table2array(readtable('MeanPerim^2_Voronoi_3.xls'));
    vor4 = table2array(readtable('MeanPerim^2_Voronoi_4.xls'));
    vor5 = table2array(readtable('MeanPerim^2_Voronoi_5.xls'));
    vor6 = table2array(readtable('MeanPerim^2_Voronoi_6.xls'));
    vor7 = table2array(readtable('MeanPerim^2_Voronoi_7.xls'));
    vor8 = table2array(readtable('MeanPerim^2_Voronoi_8.xls'));
    vor9 = table2array(readtable('MeanPerim^2_Voronoi_9.xls'));
    vor10 = table2array(readtable('MeanPerim^2_Voronoi_10.xls'));
