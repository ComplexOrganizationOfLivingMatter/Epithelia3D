function verticesNoValidCellsInfo = getVerticesNoValidCellsDelaunay(pairNoValidCells,tripletSeeds,nSeeds,hMin,hMax,wSR)
    ...
    for nPairs = 1 : size(pairNoValidCells,1)
        ...
        pairCells(pairCells>nSeeds) = pairCells(pairCells>nSeeds) - nSeeds;
        pairCells(pairCells>nSeeds) = pairCells(pairCells>nSeeds) - nSeeds;
