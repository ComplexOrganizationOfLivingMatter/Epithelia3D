function [ dataEnergyNonPreservedMotifs ] = getEnergyInNonPreservedMotifs( outerVerticesPerCell,verticesOuter,pairCellValidCells,cellsInMotifNoContactValidCells )
