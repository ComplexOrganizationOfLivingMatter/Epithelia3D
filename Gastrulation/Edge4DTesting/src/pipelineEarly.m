function [  ] = pipelineEarly( labels3d )
%PIPELINEEARLY Summary of this function goes here
%   Detailed explanation goes here
    ...
    for i = 1:size(labels3d, 3)
        ...
        imwrite(img, colors, strcat('results/early03/segments/segment_', num2str(i), '.jpg')); 
    end
