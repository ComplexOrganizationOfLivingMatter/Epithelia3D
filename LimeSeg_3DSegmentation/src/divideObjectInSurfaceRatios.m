...
%
    for numPartition = 1:totalPartitions+1
        h = figure; paint3D( imageOfSurfaceRatios{numPartition, 3}, [], colours);
        print(h, fullfile(selpath, 'Results', ['gland_SR' num2str(meanSurfaceRatio(numPartition))]),'-dtiff','-r300')
    end
