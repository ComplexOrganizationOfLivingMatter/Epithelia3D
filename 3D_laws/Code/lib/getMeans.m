function [totalMeansMean,totalStdsMean,totalMeansStd,totalStdsStd] = getMeans(path2load,kindOfSrOrientation)

    vor1 = table2array(readtable([path2load '1' kindOfSrOrientation '.xls']));
    vor2 = table2array(readtable([path2load '2' kindOfSrOrientation '.xls']));
    vor3 = table2array(readtable([path2load '3' kindOfSrOrientation '.xls']));
    vor4 = table2array(readtable([path2load '4' kindOfSrOrientation '.xls']));
    vor5 = table2array(readtable([path2load '5' kindOfSrOrientation '.xls']));
    vor6 = table2array(readtable([path2load '6' kindOfSrOrientation '.xls']));
    vor7 = table2array(readtable([path2load '7' kindOfSrOrientation '.xls']));
    vor8 = table2array(readtable([path2load '8' kindOfSrOrientation '.xls']));
    vor9 = table2array(readtable([path2load '9' kindOfSrOrientation '.xls']));
    vor10 = table2array(readtable([path2load '10' kindOfSrOrientation '.xls']));
