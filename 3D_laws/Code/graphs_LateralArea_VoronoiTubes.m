...
path2load = '..\delaunayData\geometryMeasurementsVoronoiTubes\lateralAreas\';
kindOfSr = '_apicalToBasal';
[totalMeansMean,totalStdsMean,totalMeansStd,totalStdsStd] = getMeans([path2load 'LateralAreas_Voronoi_'],kindOfSr);
...
print(h,[path2load 'heatMap_averageMeansLateralArea_' date '.tif'],'-dtiff','-r300')
savefig(h,[path2load 'heatMap_averageMeansLateralArea_' date  '.fig'])
...
% 
% print(h,[path2load 'plot_averageLateralArea_' date '.tif'],'-dtiff','-r300')
% savefig(h,[path2load 'plot_averageLateralArea_' date '.fig'])
% 
% %% Plot 2 - Fluctuations
% close all
% h = figure('units','normalized','outerposition',[0 0 1 1],'Visible','on');
...
% legend({'V1','V2','V3','V4','V5','V6','V7','V8','V9','V10'})
% 
% print(h,[path2load 'plot_ErrorBar_FluctuationsLateralArea_' date '.tif'],'-dtiff','-r300')
% savefig(h,[path2load 'plot_ErrorBar_FluctuationsLateralArea_' date '.fig'])
