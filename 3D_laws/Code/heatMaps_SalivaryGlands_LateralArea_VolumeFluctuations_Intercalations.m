...
meanIntercalations = [0	0.217145989	0.562937767	0.84796999	1.068780088	1.234342608	1.333343618];
...
print(h3,['heatMap_intercalations_Gland_' date '.tif'],'-dtiff','-r300')
savefig(h3,['heatMap_intercalations_Gland_' date  '.fig'])