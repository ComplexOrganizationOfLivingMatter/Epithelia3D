...
%     figure;imshow(finalLayer1Inner,c)
    ...
    noValidCellsLayer1 = unique([noValidCellsLayer1Outer;noValidCellsLayer1Inner]);
    noValidCellsLayer2 = unique([noValidCellsLayer2Outer;noValidCellsLayer2Inner]);

    
    finalLayer1Outer(~ismember(finalLayer1Outer,cellsLayer1))=0;
    finalLayer1Inner(~ismember(finalLayer1Inner,cellsLayer1))=0;
    finalLayer2Outer(~ismember(finalLayer2Outer,cellsLayer2))=0;
    finalLayer2Inner(~ismember(finalLayer2Inner,cellsLayer2))=0;
