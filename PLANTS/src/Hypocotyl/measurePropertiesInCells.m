function [surfaceRatio, averageTable, individualDataTable] = measurePropertiesInCells(basalLayer,apicalLayer,noValidCells)
    ...
    averageTable = array2table([[averageAreaBasal;averageAreaApical],[averageOrientationCellsBasal;averageOrientationCellsApical],[averageMajorAxisBasal;...
        averageMajorAxisApical],[averageMinorAxisBasal;averageMinorAxisApical],[averageRatioLengthAxesBasal;...
        averageRatioLengthAxesApical]],'VariableNames',{'area','orientation','majorAx','minorAx','ratioAx'},'RowNames',{'Basal','Apical'});
