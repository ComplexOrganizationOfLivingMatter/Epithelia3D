...
%   Detailed explanation goes here
    ...
    try
        ...
        for numBorders = 1:size(ellipsoidInfo.bordersSituatedAt)
            ...
            renameVariablesOfStructAddingSuffix(exchangeNeighboursInfo, num2str(exchangeNeighboursInfo.bordersSituatedAt));
        end
