...
%   Detailed explanation goes here
    ...
    ellipsoidInfo.minDistanceBetweenCentroids = (ellipsoidInfo.areaOfEllipsoid / maxNumberOfCellsInVoronoi) - (ellipsoidInfo.areaOfEllipsoid / maxNumberOfCellsInVoronoi * 0.1);
