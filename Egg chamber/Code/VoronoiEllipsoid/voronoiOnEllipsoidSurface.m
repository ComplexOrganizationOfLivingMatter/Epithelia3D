...
%   Detailed explanation goes here
    ...
    for apicalReduction = 0.1:0.1:0.9
        ...
        %Saving info
        save(strcat('results/ellipsoidReducted_x', strrep(num2str(ellipsoidInfo.xRadius), '.', ''), '_y', strrep(num2str(ellipsoidInfo.yRadius), '.', ''), '_z', strrep(num2str(ellipsoidInfo.zRadius), '.', ''), '_apicalReduction', num2str(apicalReduction)), 'ellipsoidInfo', 'minDistanceBetweenCentroids');
    end
end
