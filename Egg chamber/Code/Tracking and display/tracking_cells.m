function tracking_cells(folder,n_frame)
...
Img_list=dir(['..\..\Segmented images\' folder '\Skeleton_images\Skel*.tif']);
    ...
    for n=n_min_2:n_max %n_min
        ...
        I=imread(['..\..\Segmented images\' folder '\Skeleton_images\Skel_' num2str(n,'%02d') '.tif']);
        
        %load next skeleton to be display for comparison labels
        if n<n_max
               I_next=imread(['..\..\Segmented images\' folder '\Skeleton_images\Skel_' num2str(n+1,'%02d') '.tif']);
        end
        ...
        if n~=n_min
            ...
            %%%%%%%%%%%%%%%% COMPARE AREAS %%%%%%%%%%%%%%%%%%
            load(['..\..\Segmented images data\' folder '\Label_sequence.mat'])
    ...
    if isdir(['..\..\Segmented images data\' folder])==0
        mkdir(['..\..\Segmented images data\' folder]);
    end


    save(['..\..\Segmented images data\' folder '\Label_sequence.mat'],'Seq_Img_L')
