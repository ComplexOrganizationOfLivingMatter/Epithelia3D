...
%   Detailed explanation goes here
    for i = 1:size(roiMotifsInit, 1)
        ...
        if roiMotifsInit(i, 5) > 0
            mkdir(actualDir);
            img = imread(strcat(embryoDir, '\ImageSequence\', suffixFileName, num2str(roiMotifsInit(i, 5)), '.tif'));
            ...
            img = imread(strcat(embryoDir, '\ImageSequence\', suffixFileName, num2str(roiMotifsEnd(i, 5)), '.tif'));
